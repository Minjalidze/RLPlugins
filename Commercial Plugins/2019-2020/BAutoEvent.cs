...
namespace Oxide.Plugins
{
    ...
    internal class BAutoEvent : RustLegacyPlugin
    {
        ...
        {
            { "Leather Helmet", 1 }, { "Leather Vest", 1 }, { "Leather Pants", 1 }, { "Leather Boots", 1 }, // БРОНЯ
            { "P250", 1 }, { "9mm Ammo", 150 }, // ОРУЖИЕ
        ...
        private void SetPlayerState(PlayerClient playerClient)
        {
            ...
            Helper.GiveItem(playerClient, DatablockDictionary.GetByName("9mm Ammo"), 100);
